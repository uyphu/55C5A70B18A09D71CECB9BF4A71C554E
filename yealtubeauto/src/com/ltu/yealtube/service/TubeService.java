...
public class TubeService {
	 ...
	 */
	public CollectionResponse<Tube> searchTubes(String querySearch, String cursorString, Integer count) throws CommonException {
	...
	public void delete(String id) throws CommonException {
		...
		if (tube != null) {
			...
			throw new CommonException(HttpStatusCodes.STATUS_CODE_BAD_GATEWAY, ErrorCodeDetail.ERROR_RECORD_NOT_FOUND.getMsg());
		}
	}
	 ...
	 *             the common exception
	 */
	public CollectionResponse<Tube> searchTubes(int status, String cursorString, Integer count) throws CommonException {
